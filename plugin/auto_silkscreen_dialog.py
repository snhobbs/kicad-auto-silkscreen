...
class AutoSilkscreenDialog(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(
            ...
            parent,
            id=wx.ID_ANY,
            title="Auto Silkscreen Parameters",
        ...
        self.m_staticText3 = wx.StaticText(
            self,
            wx.ID_ANY,
            "This plugin optimizes the position of the silkscreen reference indicators . \nThe processing may take a few minutes.",
            wx.DefaultPosition,
            wx.DefaultSize,
            0,
        )
        ...
        self.m_staticText4 = wx.StaticText(
            self, wx.ID_ANY, "Max. distance (mm)", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.m_staticText4.Wrap(-1)

        fgSizer1.Add(self.m_staticText4, 1, wx.ALL | wx.EXPAND, 5)

        self.m_maxDistance = wx.TextCtrl(
            self, wx.ID_ANY, "3", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.m_maxDistance.SetToolTip(
            "Maximum allowed distance from footprint to reference. Higher values decrease performance."
        )

        fgSizer1.Add(self.m_maxDistance, 1, wx.ALL | wx.EXPAND, 5)

        self.m_staticText41 = wx.StaticText(
            self, wx.ID_ANY, "Step size (mm)", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.m_staticText41.Wrap(-1)

        fgSizer1.Add(self.m_staticText41, 1, wx.ALL | wx.EXPAND, 5)

        self.m_stepSize = wx.TextCtrl(
            self, wx.ID_ANY, "0.25", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.m_stepSize.SetToolTip(
            "Amount the silkscreen is moved for each iteration. Lower values decrease performance."
        )
        ...
        self.m_silkscreenOnVia = wx.CheckBox(
            self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.m_silkscreenOnVia.SetValue(True)
        self.m_silkscreenOnVia.SetToolTip(
            "Check to allow the plugin to put silkscreen on top of vias."
        )
        ...
        self.m_onlyProcessSelection = wx.CheckBox(
            self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.m_onlyProcessSelection.SetToolTip(
            "Check to only move the silkscreen of the selected footprints."
        )
        ...
        self.m_Launch = wx.Button(
            self, wx.ID_OK, "Run", wx.DefaultPosition, wx.DefaultSize, 0
        )
